...
#
# perf_test_ssl addition
#
JAVA_OPTS="$JAVA_OPTS \
-DkeyStore=$APP_DIR/etc/ssl/client.keystore \
-DkeyStorePassword=client \
-DkeyStoreType=pkcs12 \
-DtrustStore=$APP_DIR/etc/ssl/client-trust.keystore \
-DtrustStorePassword=client \
